...
export const chiropracticVacancies: ChiropracticVacancyRecord[] = [
  {
    ...reviewed,
    id: "aligned-chiro-lithgow-chiropractor-4439544594",
    exactTitle: "Lithgow Chiropractor",
    employer: "Aligned Chiro",
    location: "Lithgow, NSW",
    employmentType: "Full-time",
    publicationDate: null,
    closingDate: null,
    applicationUrl: "https://au.linkedin.com/jobs/view/lithgow-chiropractor-at-aligned-chiro-4439544594",
    vacancyStatus: "Current",
    registrationRequirement: null,
    experienceRequirement: null,
    mentoringSupport: "The position page describes training and support; details should be confirmed directly with the employer.",
    salary: null,
    workPattern: "Four-day week stated on the position page.",
    source: "LinkedIn Jobs — Aligned Chiro position-level page",
    officialUrl: "https://au.linkedin.com/jobs/view/lithgow-chiropractor-at-aligned-chiro-4439544594",
    ...
    dataNotes: "Verified position-level page with an explicit Chiropractor title, current hiring language, detailed vacancy content and Apply action. This record is separate from the clinic directory.",
  },
