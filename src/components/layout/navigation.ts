...
export const navigationItems: readonly NavigationItem[] = [
  ...
  { label: "Knowledge Hub", href: "/intelligence", shortLabel: "Knowledge", icon: "book", group: "primary" },
  ...
  { label: "China Recruiting", href: "/china-recruiting", shortLabel: "China", icon: "briefcase", group: "research" },
  ...
  { label: "Employers", href: "/companies", shortLabel: "Employers", icon: "building", group: "research" },
...
const chineseLabels: Record<string, { label: string; shortLabel: string }> = {
  ...
  "/china-recruiting": { label: "中国秋招", shortLabel: "秋招" },
  "/opportunities": { label: "机会", shortLabel: "探索" },
  "/intelligence": { label: "知识中心", shortLabel: "知识" },
  ...
  "/companies": { label: "雇主情报", shortLabel: "雇主" },
